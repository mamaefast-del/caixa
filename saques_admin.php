...
<body>
  ...
  <div class="header">
    ...
    <nav class="nav-menu">
      ...
      <a href="saques_admin.php" class="nav-item active">
                ...
                <td>
                  <?php if ($saque['status'] === 'pendente'): ?>
                    <form action="" method="POST" style="display:inline;">
                      ...
                      <button type="submit" name="acao" value="aprovar" class="btn btn-success" onclick="return confirm('Deseja aprovar este saque?')">
                    ...
                    <form action="" method="POST" style="display:inline;">
                      <input type="hidden" name="id" value="<?= $saque['id'] ?>">
                      <button type="submit" name="acao" value="recusar" class="btn btn-danger" onclick="return confirm('Deseja recusar este saque? O valor será devolvido ao usuário.')">
